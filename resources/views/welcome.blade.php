...
<body>
        ...
        <nav class="container">
            <div class="flex items-center justify-between relative">
                ...
                <div class="flex items-center px-4">
                    <button type="button" id="hamburger" name="hamburger" class="absolute right-4 lg:hidden">
                    ...
                    <div class="hidden absolute py-5 bg-white shadow-lg rounded-lg max-w-[250px] w-full right-4 top-full lg:block lg:static lg:bg-transparent lg:max-w-full lg:shadow-none lg:rounded-none"
                        id="navbar-menu">
                        <ul class="block lg:flex items-center">
                            <!-- Home -->
                            <li class="group">
                                <a href="#home"
                                    class="text-base text-dark py-2 mx-8 lg:mx-6 flex hover:text-primary hover:underline underline-offset-4">Home</a>
                            </li>
                            <!-- About Me -->
                            <li class="group">
                                <a href="#about"
                                    class="text-base text-dark py-2 mx-8 lg:mx-6 flex hover:text-primary hover:underline underline-offset-4">About
                                    Me
                                </a>
                            </li>
                            <!-- Portoflios -->
                            <li class="group">
                                <a href="#portoflio"
                                    class="text-base text-dark py-2 mx-8 lg:mx-6 flex hover:text-primary hover:underline underline-offset-4">Portoflios</a>
                            </li>
                            <!-- Certificates -->
                            <li class="group">
                                <a href="#certificate"
                  ...
                  >
                            ...
                            <li class="group">
                                <a href="#contact"
                                    class="text-base text-dark py-2 mx-8 lg:mx-6 flex hover:text-primary hover:underline underline-offset-4">Contact
                                    Me</a>
                            </li>
            ...
            <div class="flex flex-wrap">
                ...
                <div class="w-full self-end px-4 lg:w-1/2">
                    <div class="relative mt-10 lg:mt-9 lg-rigth-0">
                        <img src="{{ asset('images/fazril.png') }}" alt="Fazril Arief Nugraha"
            ...
            <div class="flex flex-wrap">
                    ...
                    <div class="container-fluid grid grid-cols-1 md:grid-cols-2">
                        ...
                        <div class="container-fluid mb-5">
                            ...
                            <div class="flex flex-nowrap">
                                <span class="mx-1">
                                    <img src="https://skillicons.dev/icons?i=html" class="w-8 h-8" alt="html5 logo" />
                                </span>
                                <span class="mx-1">
                                    <img src="https://skillicons.dev/icons?i=css" class="w-8 h-8" alt="css3 logo" />
                                </span>
                                <span class="mx-1">
                                    <img src="https://skillicons.dev/icons?i=js" class="w-8 h-8"
                                        alt="javascript logo" />
                                </span>
                                <span class="mx-1">
                                    <img src="https://skillicons.dev/icons?i=bootstrap" class="w-8 h-8"
                                        alt="bootstrap logo" />
                                </span>
                                <span class="mx-1">
                                    <img src="https://skillicons.dev/icons?i=tailwind" class="w-8 h-8"
                                        alt="bootstrap logo" />
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="container-fluid mb-5">
                            ...
                            <div class="flex">
                                <span class="mx-1">
                                    <img src="https://skillicons.dev/icons?i=php" class="w-8 h-8" alt="html5 logo" />
                                </span>
                                <span class="mx-1">
                                    <img src="https://skillicons.dev/icons?i=laravel" class="w-8 h-8"
                                        alt="css3 logo" />
                                </span>
                                <span class="mx-1">
                                    <img src="https://skillicons.dev/icons?i=express" class="w-8 h-8"
                                        alt="javascript logo" />
                                </span>
                                <span class="mx-1">
                                    <img src="https://skillicons.dev/icons?i=prisma" class="w-8 h-8"
                                        alt="bootstrap logo" />
                                </span>
                                <span class="mx-1">
                                    <img src="https://skillicons.dev/icons?i=mysql" class="w-8 h-8"
                                        alt="bootstrap logo" />
                                </span>
                            </div>
                            <div class="flex mt-2">
                                <span class="mx-1">
                                    <img src="https://skillicons.dev/icons?i=postman" class="w-8 h-8"
                                        alt="bootstrap logo" />
                                </span>
                            </div>
                        </div>
                ...
                <div class="w-full px-4 lg:w-1/2">
                    ...
                    <div class="flex items-center">
                        <!-- Instagram -->
                        <a href="https://www.instagram.com/f.zril/" target="_blank"
                        ...
                        <!-- LinkedIn -->
                        <a href="https://www.linkedin.com/in/fazril-arief-nugraha-8aa564209/" target="_blank"
                            class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border text-slate-500 border-slate-400 hover:border-primary hover:bg-primary hover:text-white">
                            <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                                width="20" class="fill-current">
                        ...
                        <!-- Medium -->
                        <a href="https://medium.com/@mynameisJRIKS" target="_blank"
                            class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border text-slate-500 border-slate-400 hover:border-primary hover:bg-primary hover:text-white">
                            <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                                width="20" class="fill-current">
                                <title>Medium</title>
              ...
              >
                ...
                >
                  ...
                  />
                        ...
                        <!-- Github -->
                        <a href="https://github.com/fazrilarief" target="_blank"
                            class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border text-slate-500 border-slate-400 hover:border-primary hover:bg-primary hover:text-white">
                            <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                                width="20" class="fill-current">
                                <title>GitHub</title>
                        ...
                        <div class="p-5 flex flex-col">
                            <div class="rounded-xl overflow-hidden flex items-center shadow-md h-[220px]">
                                <a href="https://fazrilarief.github.io/kerjain.com/" target="_blank">
                                    <img src="{{ asset('images/portfolios/kerjain.com.png') }}" alt="kerjain.com"
                            ...
                            <div class="container-fluid mt-5 flex justify-between items-center">
                                ...
                                <div class="github">
                                    <span
                                        ...
                                        <a href="https://github.com/fazrilarief/kerjain.com" target="_blank">
                        ...
                        <div class="p-5 flex flex-col">
                            <div class="rounded-xl overflow-hidden flex items-center shadow-md h-[220px]">
                                <a href="https://fazrilarief.github.io/baca-buku/" target="_blank">
                                    <img src="{{ asset('images/portfolios/bacabuku.png') }}" alt="bacabuku"
                                        class="hover:scale-110" />
                                </a>
                            </div>
                            <h3 class="text-xl font-semibold mt-5 mb-3">
                            ...
                            <div class="container-fluid mt-5 flex justify-between items-center">
                                ...
                                <div class="github">
                                    <span
                                        class="w-9 h-9 rounded-full flex justify-center items-center border text-slate-500 border-slate-400 hover:border-primary hover:bg-primary hover:text-white">
                                        <a href="https://github.com/fazrilarief/baca-buku?tab=readme-ov-file"
                                            target="_blank">
                                            <svg role="img" viewBox="0 0 24 24"
                                                xmlns="http://www.w3.org/2000/svg" width="20"
                                                class="fill-current">
                        ...
                        <div class="p-5 flex flex-col">
                            <div class="rounded-xl overflow-hidden flex items-center shadow-md h-[220px]">
                                <a href="https://github.com/fazrilarief/laracuss" target="_blank">
                                    <img src="{{ asset('images/portfolios/laracuss.png') }}" alt="laracuss"
                                        class="hover:scale-110" />
                                </a>
                            </div>
                            <h3 class="text-xl font-semibold mt-5 mb-3">
                            ...
                            <div class="container-fluid mt-5 flex justify-between items-center">
                                <div class="flex">
                                    ...
                                    <span class="mx-1">
                                        <img src="https://skillicons.dev/icons?i=bootstrap" alt="Laravel logo"
                                            class="w-6 h-6" />
                                    </span>
                                    <span class="mx-1">
                                    ...
                                    <span class="mx-1">
                                        <img src="https://skillicons.dev/icons?i=mysql" alt="Laravel logo"
                                            class="w-6 h-6" />
                                    </span>
                                </div>
                                <div class="github">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div class="rounded-xl shadow-lg mb-3 md:mx-3">
                            <div
                                ...
                                <a href="https://www.dicoding.com/certificates/JMZVDN3LQZN9" target="_blank">
                                    <img src="{{ asset('images/certificates/dicoding.png') }}" alt="dicoding"
                        ...
                        <div class="rounded-xl shadow-lg mb-3 md:mx-3">
                            <div
                                class="rounded-xl overflow-hidden flex items-center shadow-md h-[320px] hover:opacity-80">
                                <a href="https://www.dicoding.com/certificates/L4PQQ8GNVPO1" target="_blank">
                                    <img src="{{ asset('images/certificates/dicoding-fe.png') }}" alt="Certficate"
                                        class="hover:scale-105" />
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="rounded-xl shadow-lg mb-3 md:mx-3">
                            <div
                                class="rounded-xl overflow-hidden flex items-center shadow-md h-[320px] hover:opacity-80">
                                <a href="https://buildwithangga.com/talent/fazrilarief331/full-stack-laravel-forum-web-app-complete-guide-2024"
                                    target="_blank">
                                    <img src="{{ asset('images/certificates/bwa-laracuss.png') }}"
                                        alt="sertifikat-BWA-Laracuss" class="hover:scale-105" s />
                                </a>
                            </div>
                        </div>
                        <!-- CARD END -->
                        ...
                        <div class="rounded-xl shadow-lg mb-3 md:mx-3">
                            <div
                                class="rounded-xl overflow-hidden flex items-center shadow-md h-[320px] hover:opacity-80">
                                <a href="https://www.sololearn.com/Certificate/CC-OQXYLJMF/jpg" target="_blank">
                                    <img src="{{ asset('images/certificates/html.jpg') }}" alt="HTML Dasar"
                                        class="hover:scale-105" />
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="rounded-xl shadow-lg mb-3 md:mx-3">
                            <div
                                class="rounded-xl overflow-hidden flex items-center shadow-md h-[320px] hover:opacity-80">
                                <a href="https://www.sololearn.com/Certificate/CT-QMYQOXHW/jpg" target="_blank">
                                    <img src="{{ asset('images/certificates/php.jpg') }}" alt="PHP"
                                        class="hover:scale-105" />
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="rounded-xl shadow-lg mb-3 md:mx-3">
                            <div
                                class="rounded-xl overflow-hidden flex items-center shadow-md h-[320px] hover:opacity-80">
                                <a href="https://www.testdome.com/certificates/e14e50344eed461b943e1cd79fc0b6b1"
                                    target="_blank">
                                    <img src="{{ asset('images/certificates/testDome.png') }}" alt="testdome"
                                        class="hover:scale-105" />
                                </a>
                            </div>
                        </div>
    ...
    <div id="contact" class="pt-36 pb-32 bg-slate-100">
        <div class="container">
            <div class="w-full px-4 md:flex md:items-center">
                ...
                <form action="">
                    <div class="w-full px-4 mb-8 bg-white shadow-lg rounded-md p-4 md:w-[600px]">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea cols="20" rows="5" id="name"
                                class="w-full bg-slate-200 text-dark p-3 rounded-md focus:outline-none focus:outline-primary"></textarea>
                        </div>
    ...
    <!-- Footer Section -->
    <div id="blog" class="pt-12 pb-12 bg-dark ">
        <!-- <div class="container">
        ...
        <div class="container flex justify-center items-center text-white font-bold">
            <p>&copy; 2024 - Fazril Arief Nugraha</p>
        </div>
    </div>
    <!-- Footer Section End -->

    <script src="{{ asset('js/myScript/script.js') }}"></script>
</body>
